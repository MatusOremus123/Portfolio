  ...
  return (
    <div className="fixed top-8 left-1/2 transform -translate-x-1/2 z-50">
      <nav className={`bg-gray-900/95 backdrop-blur-xl border border-gray-800 rounded-full px-4 py-3 transition-all duration-300 ${
        scrolled ? 'shadow-2xl shadow-purple-500/20' : 'shadow-xl'
      }`}>
        <div className="flex items-center space-x-3">
          ...
          <div className="relative group">
            <button className="px-6 py-3 rounded-full text-gray-300 hover:text-white hover:bg-gray-800 transition-all duration-300 flex items-center space-x-2">
            ...
            <div className="absolute top-full mt-2 left-0 w-48 opacity-0 invisible group-hover:opacity-100 group-hover:visible transition-all duration-300 transform translate-y-2 group-hover:translate-y-0">
              <div className="bg-gray-900/95 backdrop-blur-xl border border-gray-800 rounded-2xl py-2 shadow-2xl">
                <a href="#blog" className="block px-4 py-2 text-sm text-gray-300 hover:text-white hover:bg-gray-800 transition-colors">
                  Blog
                </a>
                <a href="#testimonials" className="block px-4 py-2 text-sm text-gray-300 hover:text-white hover:bg-gray-800 transition-colors">
                  Testimonials
                </a>
                <a href="#services" className="block px-4 py-2 text-sm text-gray-300 hover:text-white hover:bg-gray-800 transition-colors">
                  Services
                </a>
              </div>
            </div>
